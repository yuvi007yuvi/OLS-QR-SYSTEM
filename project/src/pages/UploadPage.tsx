...
import { Camera, Upload, MapPin, User, Phone, CheckCircle, AlertCircle } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Photo Upload Portal</h1>
            <p className="text-gray-600">Upload before and after photos for documentation</p>
          </div>

          {/* Location Details */}
          <div className="bg-gray-50 rounded-lg p-4 space-y-3">
            <div className="flex items-center">
              <span className="font-semibold text-gray-700 w-32">QR Code ID:</span>
              <span className="text-blue-600 font-mono">{location.qrCodeId}</span>
            </div>
            <div className="flex items-center">
              <MapPin className="h-4 w-4 text-gray-500 mr-2" />
              <span className="font-semibold text-gray-700 w-28">Location:</span>
              <span>{location.locationName}</span>
            </div>
            <div className="flex items-center">
              <span className="font-semibold text-gray-700 w-32 ml-6">Area:</span>
              <span>{location.area}</span>
            </div>
            <div className="flex items-center">
              <User className="h-4 w-4 text-gray-500 mr-2" />
              <span className="font-semibold text-gray-700 w-28">Supervisor:</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">Before Photo</h3>
              {uploadStatus.before && (
            ...
            {location.beforePhoto ? (
              <div className="space-y-4">
                ...
                <p className="text-green-600 text-sm font-medium">✓ Before photo uploaded successfully</p>
              </div>
            ) : (
              <div className="space-y-4">
          ...
          <div className={`bg-white rounded-lg shadow-lg p-6 ${!uploadStatus.before ? 'opacity-50 cursor-not-allowed' : ''}`}>
            ...
            {location.afterPhoto ? (
              <div className="space-y-4">
                ...
                <p className="text-green-600 text-sm font-medium">✓ After photo uploaded successfully</p>
              </div>
            ) : (
              <div className="space-y-4">
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-400 transition-colors">
        ...
        {uploadStatus.before && uploadStatus.after && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
            <div className="flex items-center">
              ...
              <div>
                <h4 className="text-green-800 font-semibold">Upload Complete!</h4>
                <p className="text-green-700">Both before and after photos have been uploaded successfully.</p>
              </div>
            </div>
          </div>
        )}
